...
Another design requirement is that the add or subtract operation
set the overflow bits.
Since the 4-bits had to be placed in to a larger data type
they should be shifted to the end towards the MSB.
This will ensure that the operation will set the overflow bit
accordingly.

Once the addition or subtraction has been performed the data
needs to be displayed on the LCD and sent back to the CPLD
