...
The user interface is derived from the state diagram
for the ARM as shown in Figure \ref{fig:armstate}.
But there are fewer states that the user must be concerned
with.
...
examples of other address that can be read from and written
to.
